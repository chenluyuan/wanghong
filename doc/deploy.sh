...
dir_base='/opt/wanghong'
deploy_name='wanghong'
dir_git='/opt/wanghong/git_src'
dir_backup='/opt/wanghong/backup'
dir_deploy='/opt/wanghong/wanghong'
dir_mvntarget='/opt/wanghong/git_src/target/wanghong'
...
sleep 10
killall -9 java
#mysql -h IP -u"user" -p"password" wanghong  < /opt/wanghong/db_sql/db.sql
